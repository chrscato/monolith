...
from utils.ocr_hcfa import process_ocr
from utils.llm_hcfa import process_llm
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(PROJECT_ROOT / 'logs' / f'preprocess_{datetime.now().strftime("%Y%m%d")}.log'),
